...
{ 
	...
	TRACE(_T("Button or command link pressed\n"));
...
// Called when the expand button is clicked.
{
	...
	TRACE(_T("Expand Button Pressed\n"));
}
...
// Called when the user clicks the Task Dialog verification check box.
{
	...
	TRACE(_T("Verification Checkbox Clicked\n"));
}
